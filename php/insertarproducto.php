...
if(isset($_POST['nombre']) && isset($_POST['precio']) && isset($_POST['envio']) && isset($_POST['nuevo']) && isset($_POST['des1']) && isset($_POST['des2']) && isset($_POST['informacion']) && isset($_POST['stock']) && isset($_POST['dimensiones']) && isset($_POST['peso']) && isset($_POST['materiales']) && isset($_POST['catego'])&& isset($_POST['sub_catego'])&& isset($_POST['tag1'])){
