...
<br><br>
<?php
		$resultado = $conexion ->query("select * from productos_del_mes where id=1"); 
		
		$fila10 = mysqli_fetch_array($resultado);
	?>
<div class="content-header">
      <div class="container-fluid">
          <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="color: #444;margin-top:1em">Productos del Mes</h1>
          </div>
          <div class="col-sm-6 text-right ml-auto" style="margin-top:1em;">
            <button type="button" class="btn btn-primary btn-small btnEditar3" 
              data-id="<?php echo $fila10[0] ?>"
              data-titulo="<?php echo $fila10[3] ?>"
              data-descripcion="<?php echo $fila10[4] ?>"
              data-tag="<?php echo $fila10[5] ?>"
              data-toggle="modal" data-target="#modalEditar3">
            <i class="fa fa-edit"></i>  Editar Sección
            </button>
          </div>
        </div>
      </div>
	...
	<div class="month-products-cont">
		<div class="month-products-item">
			<img src="../img/<?php echo $fila10[1] ?>">
		</div>
		<div class="month-products-item">
			<img src="../img/<?php echo $fila10[2] ?>">
		</div>
		<div class="month-products-circle">
			<span>#<?php echo $fila10[5] ?></span>
			<h2><?php echo $fila10[3] ?></h2>	
			<h3><?php echo $fila10[4] ?></h3>
			<a href="shop?search=<?php echo $fila10[5] ?>" class="button">COMPRAR</a>
		</div>
	</div>
</div>
</div>
...
<div class="modal fade" id="modalEditar3" tabindex="-1" role="dialog" aria-labelledby="modalEditar3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="../php/editarProductosMes.php" method="post" enctype="multipart/form-data">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEditar3">Editar Productos del Mes</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="form-group">
        <label for="">Imagen de Producto 1</label>
        <h6 style="margin-bottom:.5em;margin-top:-.5em;font-size:12px;color:#999">Te recomedamos subir solo una imagen por vez, de esta forma se envitarán errores y se podrán vizualizar correctamente.</h6>
        <input type="file" name="imagen1" placeholder="Imagen de Producto 1" id="imagenEdit3" class="form-control">
      </div>
      <div class="form-group">
        <label for="">Imagen de Producto 2</label>
        <h6 style="margin-bottom:.5em;margin-top:-.5em;font-size:12px;color:#999">Te recomedamos subir solo una imagen por vez, de esta forma se envitarán errores y se podrán vizualizar correctamente.</h6>
        <input type="file" name="imagen2" placeholder="Imagen de Producto 2" id="imagenEdit4" class="form-control">
      </div>
      <div class="form-group">
        <label for="">Texto de la Etiqueta</label>
        <h6 style="margin-bottom:.5em;margin-top:-.5em;font-size:12px;color:#999">Escoge una de las categorías que aparecerá como etiqueta en esta sección, además será a esta categoría a la que se conducirá al usuario cunado de click al botón</h6>
      ...
      <div class="form-group">
        ...
        <input type="text" name="titulo" placeholder="Título de la Sección" id="tituloEdit3" class="form-control" required>
      </div>
      <div class="form-group">
        <label for="">Texto Descriptivo</label>
        <input type="text" name="textoDes" placeholder="Texto Descriptivo" id="textoDesEdit3" class="form-control" required>
      </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
...
<script>
  ...
  $(".btnEliminarCatego").click(function(){
		...
		$('.btnEditar3').click(function(){
			...
			$('#tituloEdit3').val(titulo);
			$('#textoDesEdit3').val(descripcion);
			$('#t_tagEdit3').val(tag);
		});
