  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4" style="background:#814090">
    <!-- Brand Logo -->
    <a href="index" class="brand-link" style="background: white;">
      <img src="../../img/logo.png" alt="Clinika Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" style="text-transform:capitalize;color:white"><?php echo $arregloUsuario['nombre']; ?></a>
        </div>
      </div>
            ...
            <a class="nav-link" style="color:white;background:#814090;cursor:pointer">
              ...
              <div class="collapse" id="collapseExample">
                <div>
                  ...
                  <a href="about-us" style="display:block;padding:.5em;border-radius:.35em;padding-left:1.5em;margin-bottom:1em;color:white"><i class="fa fa-users"></i> Sobre Nosotros</a>
                </div>
              </div>
            </a>
          </li>
