    ...
    <div class="modal-content">
     <form action="../php/insertarproducto.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="number" name="envio" placeholder="Envío" id="envio" class="form-control" min="0" required>
      </div>
      <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="../php/editarproducto.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <label for="">Costo de Envío</label>
        <input type="number" name="envio" placeholder="Envio" id="envioEdit" class="form-control" min="0" required>
      </div>
      <div class="form-group">
        <label for="">Descuento</label>
        <h6 style="margin-bottom:.5em;margin-top:-.5em;font-size:12px;color:#999">Si desea que no tenga descuenta solo ponga 0</h6>
