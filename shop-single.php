...
<div class="single-product">
	...
	<div class="single-if-discount">
		...
		<div class="input-group">
            ...
            <input type="number" data-stock="<?php echo $fila[10] ?>" class="form-control" value="1" name="cant" readonly>
	...
	<div class="owl-carousel owl-carousel3 owl-theme">
	   <?php
			   $resultado = $conexion ->query("select * from productos
						where 
						categoria like '%".$fila[19]."%'
						or
						subcategoria like '%".$fila[20]."%' 
						or
						tag1 like '%".$fila[16]."%' 
						or
						tag2 like '%".$fila[17]."%' 
...
<script>
	...
	var sitePlusMinus=function(){$(".js-btn-minus").on("click",function(n){n.preventDefault(),1!=$(this).closest(".input-group").find(".form-control").val()?$(this).closest(".input-group").find(".form-control").val(parseInt($(this).closest(".input-group").find(".form-control").val())-1):$(this).closest(".input-group").find(".form-control").val(parseInt(1))}),		$('.js-btn-plus').on('click', function(e){
			e.preventDefault();
